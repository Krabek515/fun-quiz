...
const UserSelection = (props) => {
    const select = (brMember) => {
        const isCorrect = props.questionList[props.currentQuestion][1] === brMember
        const correctMember = props.questionList[props.currentQuestion][1]

        props.onAnswer(isCorrect, brMember, correctMember)
    }
